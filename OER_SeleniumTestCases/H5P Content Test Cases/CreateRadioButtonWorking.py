...
class signup(unittest.TestCase):
	...
	driver.find_element_by_xpath("/html/body/div[4]/div/div/div[2]/div[2]/div[2]/div/div/div[2]/button[4]").click() # Create Resource > Interactive Content Button xpath
        driver.find_element_by_xpath("/html/body/div[4]/div/div/div[2]/div[2]/div[6]/div/div/div[2]/form/div/div/input").click() # T and C Button Checkbox
	...
	driver.find_element_by_xpath("/html/body/div[4]/div/div/form/label[2]")
