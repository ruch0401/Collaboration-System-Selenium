...
class signup(unittest.TestCase):
	...
	driver.find_element_by_xpath("/html/body/div[4]/ul/li[4]/a").click() # Community Content Tabbed Button
	driver.find_element_by_xpath("/html/body/div[4]/div[1]/div[1]/div") # Community Content Holder Path
