...
class signup(unittest.TestCase):
	...
	driver.find_element_by_xpath("/html/body/div[4]/div/div/div[2]/div[2]/div[2]/div/div/div[2]/button[4]").click() # Create Resource > Interactive Content Button 
	...
	driver.find_element_by_xpath("/html/body/div[4]/div/div/form/div[3]") # Unsuccessful Save Alert Message Xpath
