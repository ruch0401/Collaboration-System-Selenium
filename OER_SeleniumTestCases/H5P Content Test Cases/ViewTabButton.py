...
class signup(unittest.TestCase):
	...
	driver.find_element_by_xpath("/html/body/div[4]/div/ul/li[1]/a").click() # View Tabbed Button Etherpad Module
	driver.find_element_by_xpath("/html/body/div[4]/div[1]/div/div[1]/div[2]/h2/a") # Content Xpath that is to be viewed
