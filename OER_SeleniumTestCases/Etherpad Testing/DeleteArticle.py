...
class signup(unittest.TestCase):
	...
	driver.find_element_by_xpath("/html/body/div[4]/div/div/div[2]/div[2]/div[3]/div/div/div[3]/button[2]").click()
	elem = driver.find_element_by_id("title")
	elem.send_keys(title)
	driver.find_element_by_id("create").click()
	time.sleep(10)
	driver.find_element_by_id("save").click()
	driver.find_element_by_xpath("/html/body/div[4]/div[1]/div/div[1]/div[1]/ul/li[2]/a").click() # Edit Tabbed Button
	driver.find_element_by_id("title")
	driver.find_element_by_xpath("/html/body/div[4]/div/ul/li[3]/a").click() # Delete Tabbed Button
	driver.find_element_by_xpath("/html/body/div[4]/div[2]/div/form/div/button[2]").click() # Delete Article Button
