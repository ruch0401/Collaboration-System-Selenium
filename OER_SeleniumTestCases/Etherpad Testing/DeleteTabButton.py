...
class signup(unittest.TestCase):
	...
	driver.find_element_by_xpath("/html/body/div[4]/div[1]/div/div[1]/div[1]/ul/li[2]/a").click() # Edit Tabbed Button in Etherpad Module
	driver.find_element_by_id("title")
	driver.find_element_by_xpath("/html/body/div[4]/div/ul/li[3]/a").click() # Delete Tabbed Button Etherpad Module
	driver.find_element_by_xpath("/html/body/div[4]/div[2]/div/div/samp/h1") # Delete Warning Text
