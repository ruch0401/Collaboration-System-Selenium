...
class article(unittest.TestCase):
	...
	def test_article(self):
		...
		driver.get("http://10.129.26.119/article-view/15/")
		...
		print (element.text)
		element.click()
		driver.find_element_by_xpath("//a[@href='/article-view/15/']").click()
		driver.find_element_by_xpath("//a[@href='/community-view/3/']").click()
		driver.find_element_by_xpath("//a[@href='/article-view/15/']").click()
		element =driver.find_element_by_class_name("btn-primary")
		driver.get("http://10.129.26.119/forum/forum/ancient-languages-4/")
