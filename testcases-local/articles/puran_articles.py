...
class article(unittest.TestCase):
	...
	def test_article(self):
		...
		driver.get("http://10.129.26.119/article-view/17/")
		...
		print (element.text)
		element.click()
		driver.find_element_by_xpath("//a[@href='/article-view/17/']").click()
		driver.find_element_by_xpath("//a[@href='/community-view/23/']").click()
		element =driver.find_element_by_class_name("btn-primary")
		driver.get("http://10.129.26.119/forum/forum/indian-cuisines-24/")
